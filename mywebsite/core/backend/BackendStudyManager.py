...
def StartStudyMode(VerseRef):
    model_manager = settings.MODEL_MANAGER
    model_manager.StudyMode = True
    model_manager.JustEnteredStudyMode = True
    model_manager.StudyModeVerse = VerseRef
    print(f"Init backend manager success. Verse ref: {VerseRef}")


def StopStudyMode():
    model_manager = settings.MODEL_MANAGER
    model_manager.StudyMode = False
